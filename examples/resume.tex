...
\name{Gabriel}{Acosta}
\position{Software Developer{\enskip\cdotp\enskip}Python Expert}
% \address{246-1002, Gwangmyeongmayrouge Apt. 86, Cheongna lime-ro, Seo-gu, Incheon-si, 404-180, Rep. of KOREA}

\mobile{(+54) 9 3835523746}
\email{acostadariogabriel@gmail.com}
\homepage{centaurialpha.github.io}
\github{centaurialpha}
% \linkedin{posquit0}
% \gitlab{gitlab-id}
